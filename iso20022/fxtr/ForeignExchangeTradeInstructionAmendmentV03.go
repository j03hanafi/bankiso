...
func (f *ForeignExchangeTradeInstructionAmendmentV03) AddTradeInformation() *iso20022.TradeAgreement11 {
	f.TradeInformation = new(iso20022.TradeAgreement11)
	return f.TradeInformation
}

func (f *ForeignExchangeTradeInstructionAmendmentV03) AddTradingSideIdentification() *iso20022.TradePartyIdentification6 {
...
func (f *ForeignExchangeTradeInstructionAmendmentV03) AddTradeAmounts() *iso20022.AmountsAndValueDate1 {
	f.TradeAmounts = new(iso20022.AmountsAndValueDate1)
	return f.TradeAmounts
}

func (f *ForeignExchangeTradeInstructionAmendmentV03) AddAgreedRate() *iso20022.AgreedRate1 {
...
func (f *ForeignExchangeTradeInstructionAmendmentV03) AddRegulatoryReporting() *iso20022.RegulatoryReporting4 {
	f.RegulatoryReporting = new(iso20022.RegulatoryReporting4)
	return f.RegulatoryReporting
}

func (f *ForeignExchangeTradeInstructionAmendmentV03) AddSupplementaryData() *iso20022.SupplementaryData1 {
	newValue := new(iso20022.SupplementaryData1)
	f.SupplementaryData = append(f.SupplementaryData, newValue)
	return newValue
}
func (d *Document01500103) String() (result string, ok bool) { return }
