...
func (d *Document01800106) AddMessage() *SecuritiesTransactionPendingReportV06 {
	d.Message = new(SecuritiesTransactionPendingReportV06)
	return d.Message
}
