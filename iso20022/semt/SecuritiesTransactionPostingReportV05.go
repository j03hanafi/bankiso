...
func (s *SecuritiesTransactionPostingReportV05) AddFinancialInstrumentDetails() *iso20022.FinancialInstrumentDetails17 {
	newValue := new(iso20022.FinancialInstrumentDetails17)
...
func (s *SecuritiesTransactionPostingReportV05) AddSubAccountDetails() *iso20022.SubAccountIdentification34 {
	newValue := new(iso20022.SubAccountIdentification34)
	s.SubAccountDetails = append(s.SubAccountDetails, newValue)
	return newValue
}
func (d *Document01700105) String() (result string, ok bool) { return }
