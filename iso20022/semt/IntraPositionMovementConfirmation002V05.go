...
func (d *Document01500205) AddMessage() *IntraPositionMovementConfirmation002V05 {
	d.Message = new(IntraPositionMovementConfirmation002V05)
	return d.Message
}
...
func (i *IntraPositionMovementConfirmation002V05) AddIntraPositionDetails() *iso20022.IntraPositionDetails35 {
	i.IntraPositionDetails = new(iso20022.IntraPositionDetails35)
...
func (d *Document01500205) String() (result string, ok bool) { return }
