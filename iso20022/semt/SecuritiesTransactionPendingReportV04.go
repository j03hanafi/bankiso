...
func (d *Document01800104) AddMessage() *SecuritiesTransactionPendingReportV04 {
	d.Message = new(SecuritiesTransactionPendingReportV04)
	return d.Message
}
