...
func (s *SubscriptionMultipleOrderCancellationInstructionV02) AddPoolReference() *iso20022.AdditionalReference3 {
	s.PoolReference = new(iso20022.AdditionalReference3)
	return s.PoolReference
}

func (s *SubscriptionMultipleOrderCancellationInstructionV02) AddPreviousReference() *iso20022.AdditionalReference3 {
	s.PreviousReference = new(iso20022.AdditionalReference3)
	return s.PreviousReference
}

func (s *SubscriptionMultipleOrderCancellationInstructionV02) AddOrderToBeCancelled() *iso20022.SubscriptionMultipleOrderInstruction1 {
	s.OrderToBeCancelled = new(iso20022.SubscriptionMultipleOrderInstruction1)
	return s.OrderToBeCancelled
}
func (d *Document01100102) String() (result string, ok bool) { return }
