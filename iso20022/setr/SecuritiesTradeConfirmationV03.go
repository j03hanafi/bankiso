...
func (d *Document02700103) AddMessage() *SecuritiesTradeConfirmationV03 {
	d.Message = new(SecuritiesTradeConfirmationV03)
	return d.Message
}
...
func (s *SecuritiesTradeConfirmationV03) AddIdentification() *iso20022.TransactiontIdentification4 {
	s.Identification = new(iso20022.TransactiontIdentification4)
	return s.Identification
}

func (s *SecuritiesTradeConfirmationV03) AddNumberCount() *iso20022.NumberCount1Choice {
	s.NumberCount = new(iso20022.NumberCount1Choice)
	return s.NumberCount
}

func (s *SecuritiesTradeConfirmationV03) AddReferences() *iso20022.Linkages15 {
...
func (s *SecuritiesTradeConfirmationV03) AddTradeDetails() *iso20022.Order17 {
	s.TradeDetails = new(iso20022.Order17)
...
func (s *SecuritiesTradeConfirmationV03) AddFinancialInstrumentAttributes() *iso20022.FinancialInstrumentAttributes44 {
	s.FinancialInstrumentAttributes = new(iso20022.FinancialInstrumentAttributes44)
...
func (s *SecuritiesTradeConfirmationV03) AddStipulations() *iso20022.FinancialInstrumentStipulations2 {
...
func (s *SecuritiesTradeConfirmationV03) AddCashParties() *iso20022.CashParties18 {
	s.CashParties = new(iso20022.CashParties18)
...
func (s *SecuritiesTradeConfirmationV03) AddSettlementAmount() *iso20022.AmountAndDirection28 {
	s.SettlementAmount = new(iso20022.AmountAndDirection28)
	return s.SettlementAmount
}

func (s *SecuritiesTradeConfirmationV03) AddOtherAmounts() *iso20022.OtherAmounts16 {
	newValue := new(iso20022.OtherAmounts16)
	s.OtherAmounts = append(s.OtherAmounts, newValue)
	return newValue
}

func (s *SecuritiesTradeConfirmationV03) AddOtherPrices() *iso20022.OtherPrices2 {
	newValue := new(iso20022.OtherPrices2)
...
func (d *Document02700103) String() (result string, ok bool) { return }
