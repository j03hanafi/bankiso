...
func (d *Document03900103) AddMessage() *CorporateActionCancellationAdviceV03 {
	d.Message = new(CorporateActionCancellationAdviceV03)
	return d.Message
}
...
func (c *CorporateActionCancellationAdviceV03) AddCorporateActionGeneralInformation() *iso20022.CorporateActionGeneralInformation35 {
	c.CorporateActionGeneralInformation = new(iso20022.CorporateActionGeneralInformation35)
...
func (d *Document03900103) String() (result string, ok bool) { return }
