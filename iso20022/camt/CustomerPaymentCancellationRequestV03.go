...
func (d *Document05500103) AddMessage() *CustomerPaymentCancellationRequestV03 {
	d.Message = new(CustomerPaymentCancellationRequestV03)
	return d.Message
}
...
func (c *CustomerPaymentCancellationRequestV03) AddUnderlying() *iso20022.UnderlyingTransaction7 {
	newValue := new(iso20022.UnderlyingTransaction7)
...
func (d *Document05500103) String() (result string, ok bool) { return }
