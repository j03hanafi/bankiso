...
func (d *Document05400104) AddMessage() *BankToCustomerDebitCreditNotificationV04 {
	d.Message = new(BankToCustomerDebitCreditNotificationV04)
	return d.Message
}
...
func (b *BankToCustomerDebitCreditNotificationV04) AddNotification() *iso20022.AccountNotification7 {
	newValue := new(iso20022.AccountNotification7)
...
func (d *Document05400104) String() (result string, ok bool) { return }
