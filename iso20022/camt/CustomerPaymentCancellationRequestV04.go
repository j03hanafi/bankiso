...
func (d *Document05500104) AddMessage() *CustomerPaymentCancellationRequestV04 {
	d.Message = new(CustomerPaymentCancellationRequestV04)
	return d.Message
}
...
func (c *CustomerPaymentCancellationRequestV04) AddUnderlying() *iso20022.UnderlyingTransaction11 {
	newValue := new(iso20022.UnderlyingTransaction11)
...
func (d *Document05500104) String() (result string, ok bool) { return }
