...
func (d *Document05600102) AddMessage() *FIToFIPaymentCancellationRequestV02 {
	d.Message = new(FIToFIPaymentCancellationRequestV02)
	return d.Message
}
...
func (f *FIToFIPaymentCancellationRequestV02) AddUnderlying() *iso20022.UnderlyingTransaction5 {
	newValue := new(iso20022.UnderlyingTransaction5)
...
func (d *Document05600102) String() (result string, ok bool) { return }
