...
func (r *ResolutionOfInvestigationV03) AddStatementDetails() *iso20022.StatementResolutionEntry1 {
	r.StatementDetails = new(iso20022.StatementResolutionEntry1)
...
func (d *Document02900103) String() (result string, ok bool) { return }
