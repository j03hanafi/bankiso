...
func (d *Document05600103) AddMessage() *FIToFIPaymentCancellationRequestV03 {
	d.Message = new(FIToFIPaymentCancellationRequestV03)
	return d.Message
}
...
func (f *FIToFIPaymentCancellationRequestV03) AddUnderlying() *iso20022.UnderlyingTransaction8 {
	newValue := new(iso20022.UnderlyingTransaction8)
...
func (d *Document05600103) String() (result string, ok bool) { return }
