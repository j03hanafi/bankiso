...
func (d *Document05500105) AddMessage() *CustomerPaymentCancellationRequestV05 {
	d.Message = new(CustomerPaymentCancellationRequestV05)
	return d.Message
}
...
func (c *CustomerPaymentCancellationRequestV05) AddUnderlying() *iso20022.UnderlyingTransaction12 {
	newValue := new(iso20022.UnderlyingTransaction12)
...
func (d *Document05500105) String() (result string, ok bool) { return }
