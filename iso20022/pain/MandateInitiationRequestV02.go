...
func (m *MandateInitiationRequestV02) AddMandate() *iso20022.Mandate2 {
	m.Mandate = new(iso20022.Mandate2)
	return m.Mandate
}
...
func (d *Document00900102) String() (result string, ok bool) { return }
