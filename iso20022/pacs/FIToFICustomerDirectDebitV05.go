...
func (d *Document00300105) AddMessage() *FIToFICustomerDirectDebitV05 {
	d.Message = new(FIToFICustomerDirectDebitV05)
	return d.Message
}
...
func (f *FIToFICustomerDirectDebitV05) AddGroupHeader() *iso20022.GroupHeader50 {
...
func (f *FIToFICustomerDirectDebitV05) AddDirectDebitTransactionInformation() *iso20022.DirectDebitTransactionInformation17 {
	newValue := new(iso20022.DirectDebitTransactionInformation17)
