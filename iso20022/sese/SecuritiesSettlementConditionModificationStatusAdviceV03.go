...
func (d *Document03100103) AddMessage() *SecuritiesSettlementConditionModificationStatusAdviceV03 {
	d.Message = new(SecuritiesSettlementConditionModificationStatusAdviceV03)
	return d.Message
}
...
func (s *SecuritiesSettlementConditionModificationStatusAdviceV03) AddRequestReference() *iso20022.Identification1 {
	s.RequestReference = new(iso20022.Identification1)
	return s.RequestReference
}

func (s *SecuritiesSettlementConditionModificationStatusAdviceV03) AddAccountOwner() *iso20022.PartyIdentification36Choice {
	s.AccountOwner = new(iso20022.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesSettlementConditionModificationStatusAdviceV03) AddSafekeepingAccount() *iso20022.SecuritiesAccount13 {
	s.SafekeepingAccount = new(iso20022.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesSettlementConditionModificationStatusAdviceV03) AddRequestDetails() *iso20022.RequestDetails8 {
	s.RequestDetails = new(iso20022.RequestDetails8)
	return s.RequestDetails
}

func (s *SecuritiesSettlementConditionModificationStatusAdviceV03) AddProcessingStatus() *iso20022.ProcessingStatus18Choice {
	s.ProcessingStatus = new(iso20022.ProcessingStatus18Choice)
	return s.ProcessingStatus
}

func (s *SecuritiesSettlementConditionModificationStatusAdviceV03) AddSupplementaryData() *iso20022.SupplementaryData1 {
	newValue := new(iso20022.SupplementaryData1)
	s.SupplementaryData = append(s.SupplementaryData, newValue)
	return newValue
}
func (d *Document03100103) String() (result string, ok bool) { return }
