...
func (s *SecuritiesTransactionCancellationRequestStatusAdviceV04) AddTransactionIdentification() *iso20022.TransactionIdentifications17 {
	s.TransactionIdentification = new(iso20022.TransactionIdentifications17)
	return s.TransactionIdentification
}

func (s *SecuritiesTransactionCancellationRequestStatusAdviceV04) AddProcessingStatus() *iso20022.ProcessingStatus45Choice {
	s.ProcessingStatus = new(iso20022.ProcessingStatus45Choice)
	return s.ProcessingStatus
}

func (s *SecuritiesTransactionCancellationRequestStatusAdviceV04) AddTransactionDetails() *iso20022.TransactionDetails30 {
...
func (d *Document02700104) String() (result string, ok bool) { return }
