...
func (s *SecuritiesSettlementTransactionConfirmationV01) AddIdentification() *iso20022.DocumentIdentification11 {
	s.Identification = new(iso20022.DocumentIdentification11)
	return s.Identification
}

func (s *SecuritiesSettlementTransactionConfirmationV01) AddTransactionIdentificationDetails() *iso20022.SettlementTypeAndIdentification1 {
...
func (s *SecuritiesSettlementTransactionConfirmationV01) AddAdditionalParameters() *iso20022.AdditionalParameters2 {
	s.AdditionalParameters = new(iso20022.AdditionalParameters2)
	return s.AdditionalParameters
}

func (s *SecuritiesSettlementTransactionConfirmationV01) AddTradeDetails() *iso20022.SecuritiesTradeDetails2 {
...
func (s *SecuritiesSettlementTransactionConfirmationV01) AddFinancialInstrumentAttributes() *iso20022.FinancialInstrumentAttributes8 {
	s.FinancialInstrumentAttributes = new(iso20022.FinancialInstrumentAttributes8)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionConfirmationV01) AddQuantityAndAccountDetails() *iso20022.QuantityAndAccount2 {
	s.QuantityAndAccountDetails = new(iso20022.QuantityAndAccount2)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesSettlementTransactionConfirmationV01) AddSettlementParameters() *iso20022.SettlementDetails6 {
...
func (s *SecuritiesSettlementTransactionConfirmationV01) AddReceivingSettlementParties() *iso20022.SettlementParties5 {
	s.ReceivingSettlementParties = new(iso20022.SettlementParties5)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionConfirmationV01) AddCashParties() *iso20022.CashParties3 {
	s.CashParties = new(iso20022.CashParties3)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionConfirmationV01) AddSettledAmount() *iso20022.AmountAndDirection2 {
	s.SettledAmount = new(iso20022.AmountAndDirection2)
	return s.SettledAmount
}

func (s *SecuritiesSettlementTransactionConfirmationV01) AddOtherAmounts() *iso20022.OtherAmounts4 {
	s.OtherAmounts = new(iso20022.OtherAmounts4)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionConfirmationV01) AddOtherBusinessParties() *iso20022.OtherParties2 {
...
func (s *SecuritiesSettlementTransactionConfirmationV01) AddMessageOriginator() *iso20022.PartyIdentification10Choice {
	s.MessageOriginator = new(iso20022.PartyIdentification10Choice)
	return s.MessageOriginator
}

func (s *SecuritiesSettlementTransactionConfirmationV01) AddMessageRecipient() *iso20022.PartyIdentification10Choice {
	s.MessageRecipient = new(iso20022.PartyIdentification10Choice)
	return s.MessageRecipient
}

func (s *SecuritiesSettlementTransactionConfirmationV01) AddExtension() *iso20022.Extension2 {
	newValue := new(iso20022.Extension2)
	s.Extension = append(s.Extension, newValue)
	return newValue
}
func (d *Document02500101) String() (result string, ok bool) { return }
