...
func (d *Document03200104) AddMessage() *SecuritiesSettlementTransactionGenerationNotificationV04 {
	d.Message = new(SecuritiesSettlementTransactionGenerationNotificationV04)
	return d.Message
}
...
func (s *SecuritiesSettlementTransactionGenerationNotificationV04) AddNumberCounts() *iso20022.NumberCount1Choice {
...
func (s *SecuritiesSettlementTransactionGenerationNotificationV04) AddTradeDetails() *iso20022.SecuritiesTradeDetails1 {
	s.TradeDetails = new(iso20022.SecuritiesTradeDetails1)
	return s.TradeDetails
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV04) AddFinancialInstrumentIdentification() *iso20022.SecurityIdentification14 {
	s.FinancialInstrumentIdentification = new(iso20022.SecurityIdentification14)
	return s.FinancialInstrumentIdentification
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV04) AddFinancialInstrumentAttributes() *iso20022.FinancialInstrumentAttributes35 {
...
func (s *SecuritiesSettlementTransactionGenerationNotificationV04) AddSettlementParameters() *iso20022.SettlementDetails42 {
	s.SettlementParameters = new(iso20022.SettlementDetails42)
	return s.SettlementParameters
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV04) AddDeliveringSettlementParties() *iso20022.SettlementParties11 {
	s.DeliveringSettlementParties = new(iso20022.SettlementParties11)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV04) AddReceivingSettlementParties() *iso20022.SettlementParties11 {
	s.ReceivingSettlementParties = new(iso20022.SettlementParties11)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV04) AddCashParties() *iso20022.CashParties17 {
	s.CashParties = new(iso20022.CashParties17)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV04) AddSettlementAmount() *iso20022.AmountAndDirection2 {
	s.SettlementAmount = new(iso20022.AmountAndDirection2)
	return s.SettlementAmount
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV04) AddOtherAmounts() *iso20022.OtherAmounts14 {
	s.OtherAmounts = new(iso20022.OtherAmounts14)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV04) AddOtherBusinessParties() *iso20022.OtherParties19 {
...
func (s *SecuritiesSettlementTransactionGenerationNotificationV04) AddStatusAndReason() *iso20022.StatusAndReason12 {
...
func (d *Document03200104) String() (result string, ok bool) { return }
