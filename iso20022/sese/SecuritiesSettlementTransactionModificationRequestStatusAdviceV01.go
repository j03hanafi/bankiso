...
func (d *Document03900101) AddMessage() *SecuritiesSettlementTransactionModificationRequestStatusAdviceV01 {
	d.Message = new(SecuritiesSettlementTransactionModificationRequestStatusAdviceV01)
	return d.Message
}
...
func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV01) AddAccountOwner() *iso20022.PartyIdentification36Choice {
	s.AccountOwner = new(iso20022.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV01) AddSafekeepingAccount() *iso20022.SecuritiesAccount13 {
	s.SafekeepingAccount = new(iso20022.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV01) AddTransactionIdentification() *iso20022.TransactionIdentifications18 {
	s.TransactionIdentification = new(iso20022.TransactionIdentifications18)
	return s.TransactionIdentification
}

func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV01) AddModificationProcessingStatus() *iso20022.ModificationProcessingStatus2Choice {
	s.ModificationProcessingStatus = new(iso20022.ModificationProcessingStatus2Choice)
	return s.ModificationProcessingStatus
}

func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV01) AddTransactionDetails() *iso20022.TransactionDetails45 {
...
func (d *Document03900101) String() (result string, ok bool) { return }
