...
func (d *Document03600205) AddMessage() *SecuritiesFinancingModificationInstruction002V05 {
	d.Message = new(SecuritiesFinancingModificationInstruction002V05)
	return d.Message
}
...
func (s *SecuritiesFinancingModificationInstruction002V05) AddTransactionTypeAndModificationAdditionalParameters() *iso20022.TransactionTypeAndAdditionalParameters14 {
	s.TransactionTypeAndModificationAdditionalParameters = new(iso20022.TransactionTypeAndAdditionalParameters14)
	return s.TransactionTypeAndModificationAdditionalParameters
}

func (s *SecuritiesFinancingModificationInstruction002V05) AddTradeDetails() *iso20022.SecuritiesTradeDetails12 {
...
func (s *SecuritiesFinancingModificationInstruction002V05) AddQuantityAndAccountDetails() *iso20022.QuantityAndAccount48 {
	s.QuantityAndAccountDetails = new(iso20022.QuantityAndAccount48)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesFinancingModificationInstruction002V05) AddSecuritiesFinancingAdditionalDetails() *iso20022.SecuritiesFinancingTransactionDetails32 {
...
func (s *SecuritiesFinancingModificationInstruction002V05) AddSettlementParameters() *iso20022.SettlementDetails106 {
	s.SettlementParameters = new(iso20022.SettlementDetails106)
	return s.SettlementParameters
}

func (s *SecuritiesFinancingModificationInstruction002V05) AddDeliveringSettlementParties() *iso20022.SettlementParties44 {
	s.DeliveringSettlementParties = new(iso20022.SettlementParties44)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesFinancingModificationInstruction002V05) AddReceivingSettlementParties() *iso20022.SettlementParties44 {
	s.ReceivingSettlementParties = new(iso20022.SettlementParties44)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesFinancingModificationInstruction002V05) AddOpeningSettlementAmount() *iso20022.AmountAndDirection66 {
	s.OpeningSettlementAmount = new(iso20022.AmountAndDirection66)
	return s.OpeningSettlementAmount
}

func (s *SecuritiesFinancingModificationInstruction002V05) AddSupplementaryData() *iso20022.SupplementaryData1 {
	newValue := new(iso20022.SupplementaryData1)
	s.SupplementaryData = append(s.SupplementaryData, newValue)
	return newValue
}
func (d *Document03600205) String() (result string, ok bool) { return }
