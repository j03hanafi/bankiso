...
func (s *SecuritiesSettlementTransactionModificationRequest002V04) AddModifiedTransactionDetails() *iso20022.TransactionDetails85 {
	s.ModifiedTransactionDetails = new(iso20022.TransactionDetails85)
	return s.ModifiedTransactionDetails
}

func (s *SecuritiesSettlementTransactionModificationRequest002V04) AddUpdateType() *iso20022.UpdateType22Choice {
	newValue := new(iso20022.UpdateType22Choice)
	s.UpdateType = append(s.UpdateType, newValue)
	return newValue
}
func (d *Document03800204) String() (result string, ok bool) { return }
