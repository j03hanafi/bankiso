...
func (d *Document03600105) AddMessage() *SecuritiesFinancingModificationInstructionV05 {
	d.Message = new(SecuritiesFinancingModificationInstructionV05)
	return d.Message
}
...
func (s *SecuritiesFinancingModificationInstructionV05) AddTradeDetails() *iso20022.SecuritiesTradeDetails5 {
...
func (s *SecuritiesFinancingModificationInstructionV05) AddQuantityAndAccountDetails() *iso20022.QuantityAndAccount38 {
	s.QuantityAndAccountDetails = new(iso20022.QuantityAndAccount38)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesFinancingModificationInstructionV05) AddSecuritiesFinancingAdditionalDetails() *iso20022.SecuritiesFinancingTransactionDetails27 {
...
func (s *SecuritiesFinancingModificationInstructionV05) AddSettlementParameters() *iso20022.SettlementDetails97 {
...
func (s *SecuritiesFinancingModificationInstructionV05) AddReceivingSettlementParties() *iso20022.SettlementParties36 {
	s.ReceivingSettlementParties = new(iso20022.SettlementParties36)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesFinancingModificationInstructionV05) AddOpeningSettlementAmount() *iso20022.AmountAndDirection49 {
...
func (d *Document03600105) String() (result string, ok bool) { return }
