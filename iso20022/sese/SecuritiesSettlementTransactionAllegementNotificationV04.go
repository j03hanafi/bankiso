...
func (s *SecuritiesSettlementTransactionAllegementNotificationV04) AddSettlementTypeAndAdditionalParameters() *iso20022.SettlementTypeAndAdditionalParameters2 {
...
func (s *SecuritiesSettlementTransactionAllegementNotificationV04) AddTradeDetails() *iso20022.SecuritiesTradeDetails36 {
	s.TradeDetails = new(iso20022.SecuritiesTradeDetails36)
	return s.TradeDetails
}

func (s *SecuritiesSettlementTransactionAllegementNotificationV04) AddFinancialInstrumentIdentification() *iso20022.SecurityIdentification14 {
	s.FinancialInstrumentIdentification = new(iso20022.SecurityIdentification14)
	return s.FinancialInstrumentIdentification
}

func (s *SecuritiesSettlementTransactionAllegementNotificationV04) AddFinancialInstrumentAttributes() *iso20022.FinancialInstrumentAttributes35 {
	s.FinancialInstrumentAttributes = new(iso20022.FinancialInstrumentAttributes35)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionAllegementNotificationV04) AddQuantityAndAccountDetails() *iso20022.QuantityAndAccount27 {
	s.QuantityAndAccountDetails = new(iso20022.QuantityAndAccount27)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesSettlementTransactionAllegementNotificationV04) AddSecuritiesFinancingDetails() *iso20022.SecuritiesFinancingTransactionDetails7 {
	s.SecuritiesFinancingDetails = new(iso20022.SecuritiesFinancingTransactionDetails7)
	return s.SecuritiesFinancingDetails
}

func (s *SecuritiesSettlementTransactionAllegementNotificationV04) AddSettlementParameters() *iso20022.SettlementDetails49 {
	s.SettlementParameters = new(iso20022.SettlementDetails49)
	return s.SettlementParameters
}

func (s *SecuritiesSettlementTransactionAllegementNotificationV04) AddDeliveringSettlementParties() *iso20022.SettlementParties11 {
	s.DeliveringSettlementParties = new(iso20022.SettlementParties11)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesSettlementTransactionAllegementNotificationV04) AddReceivingSettlementParties() *iso20022.SettlementParties11 {
	s.ReceivingSettlementParties = new(iso20022.SettlementParties11)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionAllegementNotificationV04) AddCashParties() *iso20022.CashParties11 {
	s.CashParties = new(iso20022.CashParties11)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionAllegementNotificationV04) AddSettlementAmount() *iso20022.AmountAndDirection22 {
	s.SettlementAmount = new(iso20022.AmountAndDirection22)
	return s.SettlementAmount
}

func (s *SecuritiesSettlementTransactionAllegementNotificationV04) AddOtherAmounts() *iso20022.OtherAmounts8 {
	s.OtherAmounts = new(iso20022.OtherAmounts8)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionAllegementNotificationV04) AddOtherBusinessParties() *iso20022.OtherParties11 {
	s.OtherBusinessParties = new(iso20022.OtherParties11)
	return s.OtherBusinessParties
}

func (s *SecuritiesSettlementTransactionAllegementNotificationV04) AddSupplementaryData() *iso20022.SupplementaryData1 {
	newValue := new(iso20022.SupplementaryData1)
	s.SupplementaryData = append(s.SupplementaryData, newValue)
	return newValue
}
func (d *Document02800104) String() (result string, ok bool) { return }
