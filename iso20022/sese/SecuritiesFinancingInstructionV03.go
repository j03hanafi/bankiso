...
func (s *SecuritiesFinancingInstructionV03) AddNumberCounts() *iso20022.NumberCount1Choice {
	s.NumberCounts = new(iso20022.NumberCount1Choice)
	return s.NumberCounts
}

func (s *SecuritiesFinancingInstructionV03) AddLinkages() *iso20022.Linkages17 {
	newValue := new(iso20022.Linkages17)
	s.Linkages = append(s.Linkages, newValue)
	return newValue
}

func (s *SecuritiesFinancingInstructionV03) AddTradeDetails() *iso20022.SecuritiesTradeDetails3 {
...
func (s *SecuritiesFinancingInstructionV03) AddSecuritiesFinancingDetails() *iso20022.SecuritiesFinancingTransactionDetails11 {
...
func (s *SecuritiesFinancingInstructionV03) AddCashParties() *iso20022.CashParties7 {
...
func (s *SecuritiesFinancingInstructionV03) AddOtherAmounts() *iso20022.OtherAmounts14 {
...
func (s *SecuritiesFinancingInstructionV03) AddSupplementaryData() *iso20022.SupplementaryData1 {
	newValue := new(iso20022.SupplementaryData1)
	s.SupplementaryData = append(s.SupplementaryData, newValue)
	return newValue
}
func (d *Document03300103) String() (result string, ok bool) { return }
