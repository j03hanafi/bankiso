...
func (d *Document02500103) AddMessage() *SecuritiesSettlementTransactionConfirmationV03 {
	d.Message = new(SecuritiesSettlementTransactionConfirmationV03)
	return d.Message
}
...
func (s *SecuritiesSettlementTransactionConfirmationV03) AddTransactionIdentificationDetails() *iso20022.SettlementTypeAndIdentification15 {
...
func (s *SecuritiesSettlementTransactionConfirmationV03) AddAdditionalParameters() *iso20022.AdditionalParameters12 {
	s.AdditionalParameters = new(iso20022.AdditionalParameters12)
	return s.AdditionalParameters
}

func (s *SecuritiesSettlementTransactionConfirmationV03) AddTradeDetails() *iso20022.SecuritiesTradeDetails2 {
...
func (s *SecuritiesSettlementTransactionConfirmationV03) AddFinancialInstrumentAttributes() *iso20022.FinancialInstrumentAttributes35 {
	s.FinancialInstrumentAttributes = new(iso20022.FinancialInstrumentAttributes35)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionConfirmationV03) AddQuantityAndAccountDetails() *iso20022.QuantityAndAccount28 {
	s.QuantityAndAccountDetails = new(iso20022.QuantityAndAccount28)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesSettlementTransactionConfirmationV03) AddSettlementParameters() *iso20022.SettlementDetails45 {
...
func (s *SecuritiesSettlementTransactionConfirmationV03) AddDeliveringSettlementParties() *iso20022.SettlementParties11 {
	s.DeliveringSettlementParties = new(iso20022.SettlementParties11)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesSettlementTransactionConfirmationV03) AddReceivingSettlementParties() *iso20022.SettlementParties11 {
	s.ReceivingSettlementParties = new(iso20022.SettlementParties11)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionConfirmationV03) AddCashParties() *iso20022.CashParties8 {
	s.CashParties = new(iso20022.CashParties8)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionConfirmationV03) AddSettledAmount() *iso20022.AmountAndDirection2 {
	s.SettledAmount = new(iso20022.AmountAndDirection2)
	return s.SettledAmount
}

func (s *SecuritiesSettlementTransactionConfirmationV03) AddOtherAmounts() *iso20022.OtherAmounts18 {
	s.OtherAmounts = new(iso20022.OtherAmounts18)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionConfirmationV03) AddOtherBusinessParties() *iso20022.OtherParties19 {
...
func (s *SecuritiesSettlementTransactionConfirmationV03) AddSupplementaryData() *iso20022.SupplementaryData1 {
	newValue := new(iso20022.SupplementaryData1)
	s.SupplementaryData = append(s.SupplementaryData, newValue)
	return newValue
}
func (d *Document02500103) String() (result string, ok bool) { return }
