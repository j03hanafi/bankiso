...
func (s *SecuritiesTransactionCancellationRequestV01) AddIdentification() *iso20022.DocumentIdentification11 {
	s.Identification = new(iso20022.DocumentIdentification11)
	return s.Identification
}

func (s *SecuritiesTransactionCancellationRequestV01) AddDetails() *iso20022.TransactionDetails11 {
	s.Details = new(iso20022.TransactionDetails11)
	return s.Details
}

func (s *SecuritiesTransactionCancellationRequestV01) AddMessageOriginator() *iso20022.PartyIdentification10Choice {
	s.MessageOriginator = new(iso20022.PartyIdentification10Choice)
	return s.MessageOriginator
}

func (s *SecuritiesTransactionCancellationRequestV01) AddMessageRecipient() *iso20022.PartyIdentification10Choice {
	s.MessageRecipient = new(iso20022.PartyIdentification10Choice)
	return s.MessageRecipient
}

func (s *SecuritiesTransactionCancellationRequestV01) AddExtension() *iso20022.Extension2 {
