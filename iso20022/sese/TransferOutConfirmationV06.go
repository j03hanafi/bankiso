...
func (d *Document00300106) AddMessage() *TransferOutConfirmationV06 {
	d.Message = new(TransferOutConfirmationV06)
	return d.Message
}
...
func (t *TransferOutConfirmationV06) AddPoolReference() *iso20022.AdditionalReference2 {
...
func (t *TransferOutConfirmationV06) AddAccountDetails() *iso20022.InvestmentAccount40 {
...
func (t *TransferOutConfirmationV06) AddSettlementDetails() *iso20022.ReceiveInformation14 {
	t.SettlementDetails = new(iso20022.ReceiveInformation14)
...
func (t *TransferOutConfirmationV06) AddCopyDetails() *iso20022.CopyInformation2 {
