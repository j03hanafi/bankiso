...
func (d *Document03400106) AddMessage() *SecuritiesFinancingStatusAdviceV06 {
	d.Message = new(SecuritiesFinancingStatusAdviceV06)
	return d.Message
}
...
func (s *SecuritiesFinancingStatusAdviceV06) AddTransactionIdentification() *iso20022.TransactionIdentifications32 {
	s.TransactionIdentification = new(iso20022.TransactionIdentifications32)
	return s.TransactionIdentification
}

func (s *SecuritiesFinancingStatusAdviceV06) AddProcessingStatus() *iso20022.ProcessingStatus51Choice {
	s.ProcessingStatus = new(iso20022.ProcessingStatus51Choice)
	return s.ProcessingStatus
}

func (s *SecuritiesFinancingStatusAdviceV06) AddMatchingStatus() *iso20022.MatchingStatus26Choice {
...
func (s *SecuritiesFinancingStatusAdviceV06) AddSettlementStatus() *iso20022.SettlementStatus18Choice {
	s.SettlementStatus = new(iso20022.SettlementStatus18Choice)
	return s.SettlementStatus
}

func (s *SecuritiesFinancingStatusAdviceV06) AddRepoCallRequestStatus() *iso20022.RepoCallRequestStatus7Choice {
	s.RepoCallRequestStatus = new(iso20022.RepoCallRequestStatus7Choice)
	return s.RepoCallRequestStatus
}

func (s *SecuritiesFinancingStatusAdviceV06) AddTransactionDetails() *iso20022.SecuritiesFinancingTransactionDetails26 {
	s.TransactionDetails = new(iso20022.SecuritiesFinancingTransactionDetails26)
	return s.TransactionDetails
}

func (s *SecuritiesFinancingStatusAdviceV06) AddSupplementaryData() *iso20022.SupplementaryData1 {
