...
func (d *Document02500106) AddMessage() *SecuritiesSettlementTransactionConfirmationV06 {
	d.Message = new(SecuritiesSettlementTransactionConfirmationV06)
	return d.Message
}
...
func (s *SecuritiesSettlementTransactionConfirmationV06) AddTransactionIdentificationDetails() *iso20022.SettlementTypeAndIdentification19 {
...
func (s *SecuritiesSettlementTransactionConfirmationV06) AddLinkages() *iso20022.Linkages41 {
	s.Linkages = new(iso20022.Linkages41)
	return s.Linkages
}

func (s *SecuritiesSettlementTransactionConfirmationV06) AddAdditionalParameters() *iso20022.AdditionalParameters22 {
	s.AdditionalParameters = new(iso20022.AdditionalParameters22)
	return s.AdditionalParameters
}

func (s *SecuritiesSettlementTransactionConfirmationV06) AddTradeDetails() *iso20022.SecuritiesTradeDetails53 {
...
func (s *SecuritiesSettlementTransactionConfirmationV06) AddFinancialInstrumentAttributes() *iso20022.FinancialInstrumentAttributes64 {
	s.FinancialInstrumentAttributes = new(iso20022.FinancialInstrumentAttributes64)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionConfirmationV06) AddQuantityAndAccountDetails() *iso20022.QuantityAndAccount41 {
	s.QuantityAndAccountDetails = new(iso20022.QuantityAndAccount41)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesSettlementTransactionConfirmationV06) AddSettlementParameters() *iso20022.SettlementDetails90 {
...
func (s *SecuritiesSettlementTransactionConfirmationV06) AddDeliveringSettlementParties() *iso20022.SettlementParties36 {
	s.DeliveringSettlementParties = new(iso20022.SettlementParties36)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesSettlementTransactionConfirmationV06) AddReceivingSettlementParties() *iso20022.SettlementParties36 {
	s.ReceivingSettlementParties = new(iso20022.SettlementParties36)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionConfirmationV06) AddCashParties() *iso20022.CashParties26 {
	s.CashParties = new(iso20022.CashParties26)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionConfirmationV06) AddSettledAmount() *iso20022.AmountAndDirection46 {
	s.SettledAmount = new(iso20022.AmountAndDirection46)
	return s.SettledAmount
}

func (s *SecuritiesSettlementTransactionConfirmationV06) AddOtherAmounts() *iso20022.OtherAmounts30 {
	s.OtherAmounts = new(iso20022.OtherAmounts30)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionConfirmationV06) AddOtherBusinessParties() *iso20022.OtherParties27 {
...
func (s *SecuritiesSettlementTransactionConfirmationV06) AddSupplementaryData() *iso20022.SupplementaryData1 {
	newValue := new(iso20022.SupplementaryData1)
	s.SupplementaryData = append(s.SupplementaryData, newValue)
	return newValue
}
func (d *Document02500106) String() (result string, ok bool) { return }
