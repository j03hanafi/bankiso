...
func (p *PortfolioTransferInstructionV04) AddPoolReference() *iso20022.AdditionalReference3 {
	p.PoolReference = new(iso20022.AdditionalReference3)
	return p.PoolReference
}

func (p *PortfolioTransferInstructionV04) AddPreviousReference() *iso20022.AdditionalReference3 {
	p.PreviousReference = new(iso20022.AdditionalReference3)
	return p.PreviousReference
}

func (p *PortfolioTransferInstructionV04) AddRelatedReference() *iso20022.AdditionalReference3 {
...
func (p *PortfolioTransferInstructionV04) AddTransferee() *iso20022.PartyIdentification2Choice {
	p.Transferee = new(iso20022.PartyIdentification2Choice)
	return p.Transferee
}

func (p *PortfolioTransferInstructionV04) AddCashAccount() *iso20022.CashAccount11 {
...
func (d *Document01200104) String() (result string, ok bool) { return }
