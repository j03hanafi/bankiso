...
func (s *SecuritiesFinancingConfirmationV03) AddTransactionIdentificationDetails() *iso20022.TransactionTypeAndAdditionalParameters3 {
...
func (s *SecuritiesFinancingConfirmationV03) AddAdditionalParameters() *iso20022.AdditionalParameters12 {
	s.AdditionalParameters = new(iso20022.AdditionalParameters12)
	return s.AdditionalParameters
}

func (s *SecuritiesFinancingConfirmationV03) AddTradeDetails() *iso20022.SecuritiesTradeDetails6 {
...
func (s *SecuritiesFinancingConfirmationV03) AddSecuritiesFinancingDetails() *iso20022.SecuritiesFinancingTransactionDetails11 {
...
func (s *SecuritiesFinancingConfirmationV03) AddCashParties() *iso20022.CashParties7 {
	s.CashParties = new(iso20022.CashParties7)
	return s.CashParties
}

func (s *SecuritiesFinancingConfirmationV03) AddSettledAmount() *iso20022.AmountAndDirection2 {
	s.SettledAmount = new(iso20022.AmountAndDirection2)
	return s.SettledAmount
}

func (s *SecuritiesFinancingConfirmationV03) AddOtherAmounts() *iso20022.OtherAmounts17 {
...
func (s *SecuritiesFinancingConfirmationV03) AddSupplementaryData() *iso20022.SupplementaryData1 {
