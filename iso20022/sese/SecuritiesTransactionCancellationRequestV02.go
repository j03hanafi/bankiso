...
func (s *SecuritiesTransactionCancellationRequestV02) AddAccountOwner() *iso20022.PartyIdentification36Choice {
	s.AccountOwner = new(iso20022.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesTransactionCancellationRequestV02) AddSafekeepingAccount() *iso20022.SecuritiesAccount13 {
	s.SafekeepingAccount = new(iso20022.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesTransactionCancellationRequestV02) AddTransactionDetails() *iso20022.TransactionDetails29 {
	s.TransactionDetails = new(iso20022.TransactionDetails29)
	return s.TransactionDetails
}

func (s *SecuritiesTransactionCancellationRequestV02) AddFXCancellation() *iso20022.FXCancellation1Choice {
	s.FXCancellation = new(iso20022.FXCancellation1Choice)
	return s.FXCancellation
}

func (s *SecuritiesTransactionCancellationRequestV02) AddSupplementaryData() *iso20022.SupplementaryData1 {
