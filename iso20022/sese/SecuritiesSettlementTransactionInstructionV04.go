...
func (d *Document02300104) AddMessage() *SecuritiesSettlementTransactionInstructionV04 {
	d.Message = new(SecuritiesSettlementTransactionInstructionV04)
	return d.Message
}
...
func (s *SecuritiesSettlementTransactionInstructionV04) AddSettlementTypeAndAdditionalParameters() *iso20022.SettlementTypeAndAdditionalParameters9 {
...
func (s *SecuritiesSettlementTransactionInstructionV04) AddNumberCounts() *iso20022.NumberCount1Choice {
	s.NumberCounts = new(iso20022.NumberCount1Choice)
	return s.NumberCounts
}

func (s *SecuritiesSettlementTransactionInstructionV04) AddLinkages() *iso20022.Linkages17 {
	newValue := new(iso20022.Linkages17)
	s.Linkages = append(s.Linkages, newValue)
	return newValue
}

func (s *SecuritiesSettlementTransactionInstructionV04) AddTradeDetails() *iso20022.SecuritiesTradeDetails1 {
...
func (s *SecuritiesSettlementTransactionInstructionV04) AddFinancialInstrumentAttributes() *iso20022.FinancialInstrumentAttributes35 {
	s.FinancialInstrumentAttributes = new(iso20022.FinancialInstrumentAttributes35)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionInstructionV04) AddQuantityAndAccountDetails() *iso20022.QuantityAndAccount25 {
	s.QuantityAndAccountDetails = new(iso20022.QuantityAndAccount25)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesSettlementTransactionInstructionV04) AddSettlementParameters() *iso20022.SettlementDetails42 {
...
func (s *SecuritiesSettlementTransactionInstructionV04) AddReceivingSettlementParties() *iso20022.SettlementParties11 {
	s.ReceivingSettlementParties = new(iso20022.SettlementParties11)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionInstructionV04) AddCashParties() *iso20022.CashParties17 {
	s.CashParties = new(iso20022.CashParties17)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionInstructionV04) AddSettlementAmount() *iso20022.AmountAndDirection2 {
	s.SettlementAmount = new(iso20022.AmountAndDirection2)
	return s.SettlementAmount
}

func (s *SecuritiesSettlementTransactionInstructionV04) AddOtherAmounts() *iso20022.OtherAmounts14 {
	s.OtherAmounts = new(iso20022.OtherAmounts14)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionInstructionV04) AddOtherBusinessParties() *iso20022.OtherParties19 {
...
func (s *SecuritiesSettlementTransactionInstructionV04) AddSupplementaryData() *iso20022.SupplementaryData1 {
	newValue := new(iso20022.SupplementaryData1)
	s.SupplementaryData = append(s.SupplementaryData, newValue)
	return newValue
}
func (d *Document02300104) String() (result string, ok bool) { return }
