...
func (s *SecuritiesSettlementTransactionInstruction002V06) AddSettlementTypeAndAdditionalParameters() *iso20022.SettlementTypeAndAdditionalParameters16 {
	s.SettlementTypeAndAdditionalParameters = new(iso20022.SettlementTypeAndAdditionalParameters16)
	return s.SettlementTypeAndAdditionalParameters
}

func (s *SecuritiesSettlementTransactionInstruction002V06) AddNumberCounts() *iso20022.NumberCount1Choice {
	s.NumberCounts = new(iso20022.NumberCount1Choice)
	return s.NumberCounts
}

func (s *SecuritiesSettlementTransactionInstruction002V06) AddLinkages() *iso20022.Linkages43 {
	newValue := new(iso20022.Linkages43)
	s.Linkages = append(s.Linkages, newValue)
	return newValue
}

func (s *SecuritiesSettlementTransactionInstruction002V06) AddTradeDetails() *iso20022.SecuritiesTradeDetails63 {
...
func (s *SecuritiesSettlementTransactionInstruction002V06) AddFinancialInstrumentAttributes() *iso20022.FinancialInstrumentAttributes78 {
	s.FinancialInstrumentAttributes = new(iso20022.FinancialInstrumentAttributes78)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionInstruction002V06) AddQuantityAndAccountDetails() *iso20022.QuantityAndAccount47 {
	s.QuantityAndAccountDetails = new(iso20022.QuantityAndAccount47)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesSettlementTransactionInstruction002V06) AddSettlementParameters() *iso20022.SettlementDetails112 {
	s.SettlementParameters = new(iso20022.SettlementDetails112)
	return s.SettlementParameters
}

func (s *SecuritiesSettlementTransactionInstruction002V06) AddStandingSettlementInstructionDetails() *iso20022.StandingSettlementInstruction12 {
...
func (s *SecuritiesSettlementTransactionInstruction002V06) AddDeliveringSettlementParties() *iso20022.SettlementParties44 {
	s.DeliveringSettlementParties = new(iso20022.SettlementParties44)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesSettlementTransactionInstruction002V06) AddReceivingSettlementParties() *iso20022.SettlementParties44 {
	s.ReceivingSettlementParties = new(iso20022.SettlementParties44)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionInstruction002V06) AddCashParties() *iso20022.CashParties30 {
	s.CashParties = new(iso20022.CashParties30)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionInstruction002V06) AddSettlementAmount() *iso20022.AmountAndDirection60 {
	s.SettlementAmount = new(iso20022.AmountAndDirection60)
	return s.SettlementAmount
}

func (s *SecuritiesSettlementTransactionInstruction002V06) AddOtherAmounts() *iso20022.OtherAmounts35 {
	s.OtherAmounts = new(iso20022.OtherAmounts35)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionInstruction002V06) AddOtherBusinessParties() *iso20022.OtherParties29 {
...
func (s *SecuritiesSettlementTransactionInstruction002V06) AddSupplementaryData() *iso20022.SupplementaryData1 {
	newValue := new(iso20022.SupplementaryData1)
	s.SupplementaryData = append(s.SupplementaryData, newValue)
	return newValue
}
func (d *Document02300206) String() (result string, ok bool) { return }
