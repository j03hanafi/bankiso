...
func (t *TransferInInstructionV05) AddPoolReference() *iso20022.AdditionalReference2 {
...
func (t *TransferInInstructionV05) AddSettlementDetails() *iso20022.DeliverInformation13 {
	t.SettlementDetails = new(iso20022.DeliverInformation13)
...
func (d *Document00500105) String() (result string, ok bool) { return }
