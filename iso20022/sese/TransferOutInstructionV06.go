...
func (d *Document00100106) AddMessage() *TransferOutInstructionV06 {
	d.Message = new(TransferOutInstructionV06)
	return d.Message
}
...
func (t *TransferOutInstructionV06) AddPoolReference() *iso20022.AdditionalReference2 {
...
func (t *TransferOutInstructionV06) AddSettlementDetails() *iso20022.ReceiveInformation15 {
	t.SettlementDetails = new(iso20022.ReceiveInformation15)
...
func (t *TransferOutInstructionV06) AddCopyDetails() *iso20022.CopyInformation2 {
