...
func (s *SecuritiesSettlementTransactionModificationRequestV04) AddModifiedTransactionDetails() *iso20022.TransactionDetails76 {
	s.ModifiedTransactionDetails = new(iso20022.TransactionDetails76)
	return s.ModifiedTransactionDetails
}

func (s *SecuritiesSettlementTransactionModificationRequestV04) AddUpdateType() *iso20022.UpdateType14Choice {
	newValue := new(iso20022.UpdateType14Choice)
	s.UpdateType = append(s.UpdateType, newValue)
	return newValue
}
func (d *Document03800104) String() (result string, ok bool) { return }
