...
func (s *SecuritiesSettlementTransactionInstructionV03) AddSettlementTypeAndAdditionalParameters() *iso20022.SettlementTypeAndAdditionalParameters1 {
...
func (s *SecuritiesSettlementTransactionInstructionV03) AddNumberCounts() *iso20022.NumberCount1Choice {
	s.NumberCounts = new(iso20022.NumberCount1Choice)
	return s.NumberCounts
}

func (s *SecuritiesSettlementTransactionInstructionV03) AddLinkages() *iso20022.Linkages17 {
	newValue := new(iso20022.Linkages17)
	s.Linkages = append(s.Linkages, newValue)
	return newValue
}

func (s *SecuritiesSettlementTransactionInstructionV03) AddTradeDetails() *iso20022.SecuritiesTradeDetails1 {
...
func (s *SecuritiesSettlementTransactionInstructionV03) AddFinancialInstrumentAttributes() *iso20022.FinancialInstrumentAttributes35 {
	s.FinancialInstrumentAttributes = new(iso20022.FinancialInstrumentAttributes35)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionInstructionV03) AddQuantityAndAccountDetails() *iso20022.QuantityAndAccount25 {
	s.QuantityAndAccountDetails = new(iso20022.QuantityAndAccount25)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesSettlementTransactionInstructionV03) AddSettlementParameters() *iso20022.SettlementDetails42 {
...
func (s *SecuritiesSettlementTransactionInstructionV03) AddReceivingSettlementParties() *iso20022.SettlementParties11 {
	s.ReceivingSettlementParties = new(iso20022.SettlementParties11)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionInstructionV03) AddCashParties() *iso20022.CashParties8 {
	s.CashParties = new(iso20022.CashParties8)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionInstructionV03) AddSettlementAmount() *iso20022.AmountAndDirection2 {
	s.SettlementAmount = new(iso20022.AmountAndDirection2)
	return s.SettlementAmount
}

func (s *SecuritiesSettlementTransactionInstructionV03) AddOtherAmounts() *iso20022.OtherAmounts14 {
	s.OtherAmounts = new(iso20022.OtherAmounts14)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionInstructionV03) AddOtherBusinessParties() *iso20022.OtherParties19 {
...
func (s *SecuritiesSettlementTransactionInstructionV03) AddSupplementaryData() *iso20022.SupplementaryData1 {
	newValue := new(iso20022.SupplementaryData1)
	s.SupplementaryData = append(s.SupplementaryData, newValue)
	return newValue
}
func (d *Document02300103) String() (result string, ok bool) { return }
