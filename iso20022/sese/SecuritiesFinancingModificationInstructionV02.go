...
func (d *Document03600102) AddMessage() *SecuritiesFinancingModificationInstructionV02 {
	d.Message = new(SecuritiesFinancingModificationInstructionV02)
	return d.Message
}
...
func (s *SecuritiesFinancingModificationInstructionV02) AddTradeDetails() *iso20022.SecuritiesTradeDetails5 {
...
func (s *SecuritiesFinancingModificationInstructionV02) AddQuantityAndAccountDetails() *iso20022.QuantityAndAccount16 {
	s.QuantityAndAccountDetails = new(iso20022.QuantityAndAccount16)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesFinancingModificationInstructionV02) AddSecuritiesFinancingAdditionalDetails() *iso20022.SecuritiesFinancingTransactionDetails1 {
...
func (s *SecuritiesFinancingModificationInstructionV02) AddSettlementParameters() *iso20022.SettlementDetails3 {
...
func (s *SecuritiesFinancingModificationInstructionV02) AddReceivingSettlementParties() *iso20022.SettlementParties10 {
	s.ReceivingSettlementParties = new(iso20022.SettlementParties10)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesFinancingModificationInstructionV02) AddOpeningSettlementAmount() *iso20022.AmountAndDirection10 {
	s.OpeningSettlementAmount = new(iso20022.AmountAndDirection10)
	return s.OpeningSettlementAmount
}

func (s *SecuritiesFinancingModificationInstructionV02) AddSupplementaryData() *iso20022.SupplementaryData1 {
