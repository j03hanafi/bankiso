...
func (d *Document03200105) AddMessage() *SecuritiesSettlementTransactionGenerationNotificationV05 {
	d.Message = new(SecuritiesSettlementTransactionGenerationNotificationV05)
	return d.Message
}
...
func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddTransactionIdentificationDetails() *iso20022.SettlementTypeAndIdentification15 {
...
func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddNumberCounts() *iso20022.NumberCount1Choice {
	s.NumberCounts = new(iso20022.NumberCount1Choice)
	return s.NumberCounts
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddLinkages() *iso20022.Linkages17 {
	newValue := new(iso20022.Linkages17)
	s.Linkages = append(s.Linkages, newValue)
	return newValue
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddTradeDetails() *iso20022.SecuritiesTradeDetails33 {
	s.TradeDetails = new(iso20022.SecuritiesTradeDetails33)
	return s.TradeDetails
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddFinancialInstrumentIdentification() *iso20022.SecurityIdentification14 {
	s.FinancialInstrumentIdentification = new(iso20022.SecurityIdentification14)
	return s.FinancialInstrumentIdentification
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddFinancialInstrumentAttributes() *iso20022.FinancialInstrumentAttributes35 {
	s.FinancialInstrumentAttributes = new(iso20022.FinancialInstrumentAttributes35)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddQuantityAndAccountDetails() *iso20022.QuantityAndAccount25 {
	newValue := new(iso20022.QuantityAndAccount25)
	s.QuantityAndAccountDetails = append(s.QuantityAndAccountDetails, newValue)
	return newValue
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddSettlementParameters() *iso20022.SettlementDetails67 {
	s.SettlementParameters = new(iso20022.SettlementDetails67)
	return s.SettlementParameters
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddDeliveringSettlementParties() *iso20022.SettlementParties11 {
	s.DeliveringSettlementParties = new(iso20022.SettlementParties11)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddReceivingSettlementParties() *iso20022.SettlementParties11 {
	s.ReceivingSettlementParties = new(iso20022.SettlementParties11)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddCashParties() *iso20022.CashParties17 {
	s.CashParties = new(iso20022.CashParties17)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddSettlementAmount() *iso20022.AmountAndDirection36 {
	s.SettlementAmount = new(iso20022.AmountAndDirection36)
	return s.SettlementAmount
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddOtherAmounts() *iso20022.OtherAmounts14 {
	s.OtherAmounts = new(iso20022.OtherAmounts14)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddOtherBusinessParties() *iso20022.OtherParties19 {
...
func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddGeneratedReason() *iso20022.GeneratedReason3 {
	newValue := new(iso20022.GeneratedReason3)
	s.GeneratedReason = append(s.GeneratedReason, newValue)
	return newValue
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddStatusAndReason() *iso20022.StatusAndReason19 {
	s.StatusAndReason = new(iso20022.StatusAndReason19)
	return s.StatusAndReason
}

func (s *SecuritiesSettlementTransactionGenerationNotificationV05) AddSupplementaryData() *iso20022.SupplementaryData1 {
	newValue := new(iso20022.SupplementaryData1)
	s.SupplementaryData = append(s.SupplementaryData, newValue)
	return newValue
}
func (d *Document03200105) String() (result string, ok bool) { return }
