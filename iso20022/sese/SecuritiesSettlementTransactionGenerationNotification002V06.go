...
func (s *SecuritiesSettlementTransactionGenerationNotification002V06) AddTransactionIdentificationDetails() *iso20022.SettlementTypeAndIdentification24 {
...
func (s *SecuritiesSettlementTransactionGenerationNotification002V06) AddNumberCounts() *iso20022.NumberCount1Choice {
	s.NumberCounts = new(iso20022.NumberCount1Choice)
	return s.NumberCounts
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V06) AddLinkages() *iso20022.Linkages43 {
	newValue := new(iso20022.Linkages43)
	s.Linkages = append(s.Linkages, newValue)
	return newValue
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V06) AddTradeDetails() *iso20022.SecuritiesTradeDetails63 {
	s.TradeDetails = new(iso20022.SecuritiesTradeDetails63)
	return s.TradeDetails
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V06) AddFinancialInstrumentIdentification() *iso20022.SecurityIdentification20 {
	s.FinancialInstrumentIdentification = new(iso20022.SecurityIdentification20)
	return s.FinancialInstrumentIdentification
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V06) AddFinancialInstrumentAttributes() *iso20022.FinancialInstrumentAttributes78 {
	s.FinancialInstrumentAttributes = new(iso20022.FinancialInstrumentAttributes78)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V06) AddQuantityAndAccountDetails() *iso20022.QuantityAndAccount47 {
	newValue := new(iso20022.QuantityAndAccount47)
	s.QuantityAndAccountDetails = append(s.QuantityAndAccountDetails, newValue)
	return newValue
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V06) AddSettlementParameters() *iso20022.SettlementDetails111 {
	s.SettlementParameters = new(iso20022.SettlementDetails111)
	return s.SettlementParameters
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V06) AddDeliveringSettlementParties() *iso20022.SettlementParties44 {
	s.DeliveringSettlementParties = new(iso20022.SettlementParties44)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V06) AddReceivingSettlementParties() *iso20022.SettlementParties44 {
	s.ReceivingSettlementParties = new(iso20022.SettlementParties44)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V06) AddCashParties() *iso20022.CashParties30 {
	s.CashParties = new(iso20022.CashParties30)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V06) AddSettlementAmount() *iso20022.AmountAndDirection60 {
	s.SettlementAmount = new(iso20022.AmountAndDirection60)
	return s.SettlementAmount
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V06) AddOtherAmounts() *iso20022.OtherAmounts35 {
	s.OtherAmounts = new(iso20022.OtherAmounts35)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V06) AddOtherBusinessParties() *iso20022.OtherParties29 {
...
func (s *SecuritiesSettlementTransactionGenerationNotification002V06) AddGeneratedReason() *iso20022.GeneratedReason6 {
	newValue := new(iso20022.GeneratedReason6)
	s.GeneratedReason = append(s.GeneratedReason, newValue)
	return newValue
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V06) AddStatusAndReason() *iso20022.StatusAndReason29 {
	s.StatusAndReason = new(iso20022.StatusAndReason29)
	return s.StatusAndReason
}

func (s *SecuritiesSettlementTransactionGenerationNotification002V06) AddSupplementaryData() *iso20022.SupplementaryData1 {
	newValue := new(iso20022.SupplementaryData1)
	s.SupplementaryData = append(s.SupplementaryData, newValue)
	return newValue
}
func (d *Document03200206) String() (result string, ok bool) { return }
