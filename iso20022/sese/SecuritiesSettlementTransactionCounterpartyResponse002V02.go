...
func (s *SecuritiesSettlementTransactionCounterpartyResponse002V02) AddResponseStatus() *iso20022.ResponseStatus8Choice {
	s.ResponseStatus = new(iso20022.ResponseStatus8Choice)
	return s.ResponseStatus
}

func (s *SecuritiesSettlementTransactionCounterpartyResponse002V02) AddTransactionDetails() *iso20022.TransactionDetails92 {
	s.TransactionDetails = new(iso20022.TransactionDetails92)
...
func (d *Document04000202) String() (result string, ok bool) { return }
