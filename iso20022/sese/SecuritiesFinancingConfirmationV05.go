...
func (s *SecuritiesFinancingConfirmationV05) AddTransactionIdentificationDetails() *iso20022.TransactionTypeAndAdditionalParameters3 {
...
func (s *SecuritiesFinancingConfirmationV05) AddAdditionalParameters() *iso20022.AdditionalParameters18 {
	s.AdditionalParameters = new(iso20022.AdditionalParameters18)
	return s.AdditionalParameters
}

func (s *SecuritiesFinancingConfirmationV05) AddTradeDetails() *iso20022.SecuritiesTradeDetails38 {
	s.TradeDetails = new(iso20022.SecuritiesTradeDetails38)
...
func (s *SecuritiesFinancingConfirmationV05) AddSecuritiesFinancingDetails() *iso20022.SecuritiesFinancingTransactionDetails11 {
...
func (s *SecuritiesFinancingConfirmationV05) AddSettlementParameters() *iso20022.SettlementDetails71 {
	s.SettlementParameters = new(iso20022.SettlementDetails71)
...
func (s *SecuritiesFinancingConfirmationV05) AddCashParties() *iso20022.CashParties17 {
	s.CashParties = new(iso20022.CashParties17)
	return s.CashParties
}

func (s *SecuritiesFinancingConfirmationV05) AddSettledAmount() *iso20022.AmountAndDirection36 {
	s.SettledAmount = new(iso20022.AmountAndDirection36)
	return s.SettledAmount
}

func (s *SecuritiesFinancingConfirmationV05) AddOtherAmounts() *iso20022.OtherAmounts17 {
...
func (s *SecuritiesFinancingConfirmationV05) AddSupplementaryData() *iso20022.SupplementaryData1 {
	newValue := new(iso20022.SupplementaryData1)
	s.SupplementaryData = append(s.SupplementaryData, newValue)
	return newValue
}
func (d *Document03500105) String() (result string, ok bool) { return }
