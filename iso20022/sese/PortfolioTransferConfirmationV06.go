...
func (p *PortfolioTransferConfirmationV06) AddPoolReference() *iso20022.AdditionalReference3 {
	p.PoolReference = new(iso20022.AdditionalReference3)
	return p.PoolReference
}

func (p *PortfolioTransferConfirmationV06) AddPreviousReference() *iso20022.AdditionalReference3 {
	p.PreviousReference = new(iso20022.AdditionalReference3)
	return p.PreviousReference
}

func (p *PortfolioTransferConfirmationV06) AddRelatedReference() *iso20022.AdditionalReference3 {
...
func (p *PortfolioTransferConfirmationV06) AddTransferee() *iso20022.PartyIdentification2Choice {
	p.Transferee = new(iso20022.PartyIdentification2Choice)
	return p.Transferee
}

func (p *PortfolioTransferConfirmationV06) AddCashAccount() *iso20022.CashAccount29 {
...
func (d *Document01300106) String() (result string, ok bool) { return }
