...
func (s *SecuritiesFinancingInstruction002V06) AddTransactionTypeAndAdditionalParameters() *iso20022.TransactionTypeAndAdditionalParameters13 {
	s.TransactionTypeAndAdditionalParameters = new(iso20022.TransactionTypeAndAdditionalParameters13)
	return s.TransactionTypeAndAdditionalParameters
}

func (s *SecuritiesFinancingInstruction002V06) AddNumberCounts() *iso20022.NumberCount1Choice {
	s.NumberCounts = new(iso20022.NumberCount1Choice)
	return s.NumberCounts
}

func (s *SecuritiesFinancingInstruction002V06) AddLinkages() *iso20022.Linkages43 {
	newValue := new(iso20022.Linkages43)
	s.Linkages = append(s.Linkages, newValue)
	return newValue
}

func (s *SecuritiesFinancingInstruction002V06) AddTradeDetails() *iso20022.SecuritiesTradeDetails59 {
...
func (s *SecuritiesFinancingInstruction002V06) AddSecuritiesFinancingDetails() *iso20022.SecuritiesFinancingTransactionDetails30 {
	s.SecuritiesFinancingDetails = new(iso20022.SecuritiesFinancingTransactionDetails30)
	return s.SecuritiesFinancingDetails
}

func (s *SecuritiesFinancingInstruction002V06) AddSettlementParameters() *iso20022.SettlementDetails105 {
...
func (s *SecuritiesFinancingInstruction002V06) AddCashParties() *iso20022.CashParties30 {
...
func (s *SecuritiesFinancingInstruction002V06) AddOtherAmounts() *iso20022.OtherAmounts35 {
...
func (s *SecuritiesFinancingInstruction002V06) AddSupplementaryData() *iso20022.SupplementaryData1 {
	newValue := new(iso20022.SupplementaryData1)
	s.SupplementaryData = append(s.SupplementaryData, newValue)
	return newValue
}
func (d *Document03300206) String() (result string, ok bool) { return }
