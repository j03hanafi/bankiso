...
func (s *SecuritiesSettlementTransactionCounterpartyResponseV02) AddTransactionIdentification() *iso20022.TransactionIdentification6 {
	s.TransactionIdentification = new(iso20022.TransactionIdentification6)
	return s.TransactionIdentification
}

func (s *SecuritiesSettlementTransactionCounterpartyResponseV02) AddResponseStatus() *iso20022.ResponseStatus6Choice {
	s.ResponseStatus = new(iso20022.ResponseStatus6Choice)
	return s.ResponseStatus
}

func (s *SecuritiesSettlementTransactionCounterpartyResponseV02) AddTransactionDetails() *iso20022.TransactionDetails82 {
	s.TransactionDetails = new(iso20022.TransactionDetails82)
	return s.TransactionDetails
}

func (s *SecuritiesSettlementTransactionCounterpartyResponseV02) AddSupplementaryData() *iso20022.SupplementaryData1 {
