...
func (d *Document00700104) AddMessage() *TransferInConfirmationV04 {
	d.Message = new(TransferInConfirmationV04)
	return d.Message
}
...
func (t *TransferInConfirmationV04) AddPoolReference() *iso20022.AdditionalReference2 {
...
func (t *TransferInConfirmationV04) AddTransferDetails() *iso20022.Transfer26 {
	newValue := new(iso20022.Transfer26)
...
func (t *TransferInConfirmationV04) AddSettlementDetails() *iso20022.DeliverInformation11 {
	t.SettlementDetails = new(iso20022.DeliverInformation11)
	return t.SettlementDetails
}

func (t *TransferInConfirmationV04) AddCopyDetails() *iso20022.CopyInformation2 {
...
func (d *Document00700104) String() (result string, ok bool) { return }
