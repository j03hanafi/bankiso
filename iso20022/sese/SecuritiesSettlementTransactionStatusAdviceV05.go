...
func (d *Document02400105) AddMessage() *SecuritiesSettlementTransactionStatusAdviceV05 {
	d.Message = new(SecuritiesSettlementTransactionStatusAdviceV05)
	return d.Message
}
...
func (s *SecuritiesSettlementTransactionStatusAdviceV05) AddTransactionIdentification() *iso20022.TransactionIdentifications16 {
	s.TransactionIdentification = new(iso20022.TransactionIdentifications16)
	return s.TransactionIdentification
}

func (s *SecuritiesSettlementTransactionStatusAdviceV05) AddProcessingStatus() *iso20022.ProcessingStatus37Choice {
	s.ProcessingStatus = new(iso20022.ProcessingStatus37Choice)
	return s.ProcessingStatus
}

func (s *SecuritiesSettlementTransactionStatusAdviceV05) AddInferredMatchingStatus() *iso20022.MatchingStatus19Choice {
	s.InferredMatchingStatus = new(iso20022.MatchingStatus19Choice)
	return s.InferredMatchingStatus
}

func (s *SecuritiesSettlementTransactionStatusAdviceV05) AddMatchingStatus() *iso20022.MatchingStatus19Choice {
	s.MatchingStatus = new(iso20022.MatchingStatus19Choice)
	return s.MatchingStatus
}

func (s *SecuritiesSettlementTransactionStatusAdviceV05) AddSettlementStatus() *iso20022.SettlementStatus7Choice {
	s.SettlementStatus = new(iso20022.SettlementStatus7Choice)
	return s.SettlementStatus
}

func (s *SecuritiesSettlementTransactionStatusAdviceV05) AddTransactionDetails() *iso20022.TransactionDetails61 {
	s.TransactionDetails = new(iso20022.TransactionDetails61)
	return s.TransactionDetails
}

func (s *SecuritiesSettlementTransactionStatusAdviceV05) AddSupplementaryData() *iso20022.SupplementaryData1 {
	newValue := new(iso20022.SupplementaryData1)
	s.SupplementaryData = append(s.SupplementaryData, newValue)
	return newValue
}
func (d *Document02400105) String() (result string, ok bool) { return }
