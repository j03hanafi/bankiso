...
func (s *SecuritiesSettlementTransactionConfirmation002V06) AddTransactionIdentificationDetails() *iso20022.SettlementTypeAndIdentification24 {
...
func (s *SecuritiesSettlementTransactionConfirmation002V06) AddLinkages() *iso20022.Linkages50 {
	s.Linkages = new(iso20022.Linkages50)
	return s.Linkages
}

func (s *SecuritiesSettlementTransactionConfirmation002V06) AddAdditionalParameters() *iso20022.AdditionalParameters27 {
	s.AdditionalParameters = new(iso20022.AdditionalParameters27)
	return s.AdditionalParameters
}

func (s *SecuritiesSettlementTransactionConfirmation002V06) AddTradeDetails() *iso20022.SecuritiesTradeDetails62 {
...
func (s *SecuritiesSettlementTransactionConfirmation002V06) AddFinancialInstrumentAttributes() *iso20022.FinancialInstrumentAttributes78 {
	s.FinancialInstrumentAttributes = new(iso20022.FinancialInstrumentAttributes78)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionConfirmation002V06) AddQuantityAndAccountDetails() *iso20022.QuantityAndAccount51 {
	s.QuantityAndAccountDetails = new(iso20022.QuantityAndAccount51)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesSettlementTransactionConfirmation002V06) AddSettlementParameters() *iso20022.SettlementDetails110 {
	s.SettlementParameters = new(iso20022.SettlementDetails110)
	return s.SettlementParameters
}

func (s *SecuritiesSettlementTransactionConfirmation002V06) AddStandingSettlementInstructionDetails() *iso20022.StandingSettlementInstruction12 {
...
func (s *SecuritiesSettlementTransactionConfirmation002V06) AddDeliveringSettlementParties() *iso20022.SettlementParties44 {
	s.DeliveringSettlementParties = new(iso20022.SettlementParties44)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesSettlementTransactionConfirmation002V06) AddReceivingSettlementParties() *iso20022.SettlementParties44 {
	s.ReceivingSettlementParties = new(iso20022.SettlementParties44)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionConfirmation002V06) AddCashParties() *iso20022.CashParties30 {
	s.CashParties = new(iso20022.CashParties30)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionConfirmation002V06) AddSettledAmount() *iso20022.AmountAndDirection60 {
	s.SettledAmount = new(iso20022.AmountAndDirection60)
	return s.SettledAmount
}

func (s *SecuritiesSettlementTransactionConfirmation002V06) AddOtherAmounts() *iso20022.OtherAmounts38 {
	s.OtherAmounts = new(iso20022.OtherAmounts38)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionConfirmation002V06) AddOtherBusinessParties() *iso20022.OtherParties29 {
...
func (s *SecuritiesSettlementTransactionConfirmation002V06) AddSupplementaryData() *iso20022.SupplementaryData1 {
	newValue := new(iso20022.SupplementaryData1)
	s.SupplementaryData = append(s.SupplementaryData, newValue)
	return newValue
}
func (d *Document02500206) String() (result string, ok bool) { return }
