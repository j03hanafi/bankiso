...
func (s *SecuritiesFinancingModificationInstructionV03) AddTradeDetails() *iso20022.SecuritiesTradeDetails5 {
...
func (s *SecuritiesFinancingModificationInstructionV03) AddQuantityAndAccountDetails() *iso20022.QuantityAndAccount16 {
	s.QuantityAndAccountDetails = new(iso20022.QuantityAndAccount16)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesFinancingModificationInstructionV03) AddSecuritiesFinancingAdditionalDetails() *iso20022.SecuritiesFinancingTransactionDetails19 {
...
func (s *SecuritiesFinancingModificationInstructionV03) AddSettlementParameters() *iso20022.SettlementDetails62 {
	s.SettlementParameters = new(iso20022.SettlementDetails62)
...
func (s *SecuritiesFinancingModificationInstructionV03) AddReceivingSettlementParties() *iso20022.SettlementParties10 {
	s.ReceivingSettlementParties = new(iso20022.SettlementParties10)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesFinancingModificationInstructionV03) AddOpeningSettlementAmount() *iso20022.AmountAndDirection10 {
	s.OpeningSettlementAmount = new(iso20022.AmountAndDirection10)
	return s.OpeningSettlementAmount
}

func (s *SecuritiesFinancingModificationInstructionV03) AddSupplementaryData() *iso20022.SupplementaryData1 {
	newValue := new(iso20022.SupplementaryData1)
	s.SupplementaryData = append(s.SupplementaryData, newValue)
	return newValue
}
func (d *Document03600103) String() (result string, ok bool) { return }
