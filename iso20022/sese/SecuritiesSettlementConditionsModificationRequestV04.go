...
func (s *SecuritiesSettlementConditionsModificationRequestV04) AddAccountOwner() *iso20022.PartyIdentification36Choice {
	s.AccountOwner = new(iso20022.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesSettlementConditionsModificationRequestV04) AddSafekeepingAccount() *iso20022.SecuritiesAccount13 {
	s.SafekeepingAccount = new(iso20022.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesSettlementConditionsModificationRequestV04) AddRequestDetails() *iso20022.RequestDetails11 {
	newValue := new(iso20022.RequestDetails11)
	s.RequestDetails = append(s.RequestDetails, newValue)
	return newValue
}

func (s *SecuritiesSettlementConditionsModificationRequestV04) AddAdditionalInformation() *iso20022.AdditionalInformation7 {
	newValue := new(iso20022.AdditionalInformation7)
	s.AdditionalInformation = append(s.AdditionalInformation, newValue)
	return newValue
}

func (s *SecuritiesSettlementConditionsModificationRequestV04) AddSupplementaryData() *iso20022.SupplementaryData1 {
