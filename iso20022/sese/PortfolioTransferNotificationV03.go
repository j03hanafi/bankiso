...
func (p *PortfolioTransferNotificationV03) AddAccountOwner() *iso20022.PartyIdentification36Choice {
	p.AccountOwner = new(iso20022.PartyIdentification36Choice)
	return p.AccountOwner
}

func (p *PortfolioTransferNotificationV03) AddSafekeepingAccount() *iso20022.SecuritiesAccount13 {
...
func (d *Document03700103) String() (result string, ok bool) { return }
