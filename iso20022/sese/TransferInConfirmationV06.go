...
func (d *Document00700106) AddMessage() *TransferInConfirmationV06 {
	d.Message = new(TransferInConfirmationV06)
	return d.Message
}
...
func (t *TransferInConfirmationV06) AddPoolReference() *iso20022.AdditionalReference2 {
...
func (t *TransferInConfirmationV06) AddSettlementDetails() *iso20022.DeliverInformation14 {
	t.SettlementDetails = new(iso20022.DeliverInformation14)
...
func (t *TransferInConfirmationV06) AddCopyDetails() *iso20022.CopyInformation2 {
