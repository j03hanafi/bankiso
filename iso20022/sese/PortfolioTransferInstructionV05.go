...
func (d *Document01200105) AddMessage() *PortfolioTransferInstructionV05 {
	d.Message = new(PortfolioTransferInstructionV05)
	return d.Message
}
...
func (p *PortfolioTransferInstructionV05) AddMessageReference() *iso20022.MessageIdentification1 {
	p.MessageReference = new(iso20022.MessageIdentification1)
	return p.MessageReference
}

func (p *PortfolioTransferInstructionV05) AddPoolReference() *iso20022.AdditionalReference3 {
	p.PoolReference = new(iso20022.AdditionalReference3)
	return p.PoolReference
}

func (p *PortfolioTransferInstructionV05) AddPreviousReference() *iso20022.AdditionalReference3 {
	p.PreviousReference = new(iso20022.AdditionalReference3)
	return p.PreviousReference
}

func (p *PortfolioTransferInstructionV05) AddRelatedReference() *iso20022.AdditionalReference3 {
...
func (p *PortfolioTransferInstructionV05) AddTransferee() *iso20022.PartyIdentification2Choice {
	p.Transferee = new(iso20022.PartyIdentification2Choice)
	return p.Transferee
}

func (p *PortfolioTransferInstructionV05) AddCashAccount() *iso20022.CashAccount29 {
...
func (p *PortfolioTransferInstructionV05) AddProductTransfer() *iso20022.ISATransfer16 {
	newValue := new(iso20022.ISATransfer16)
...
func (p *PortfolioTransferInstructionV05) AddExtension() *iso20022.Extension1 {
	newValue := new(iso20022.Extension1)
	p.Extension = append(p.Extension, newValue)
	return newValue
}
func (d *Document01200105) String() (result string, ok bool) { return }
