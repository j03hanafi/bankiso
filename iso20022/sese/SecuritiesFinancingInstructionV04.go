...
func (d *Document03300104) AddMessage() *SecuritiesFinancingInstructionV04 {
	d.Message = new(SecuritiesFinancingInstructionV04)
	return d.Message
}
...
func (s *SecuritiesFinancingInstructionV04) AddNumberCounts() *iso20022.NumberCount1Choice {
	s.NumberCounts = new(iso20022.NumberCount1Choice)
	return s.NumberCounts
}

func (s *SecuritiesFinancingInstructionV04) AddLinkages() *iso20022.Linkages17 {
	newValue := new(iso20022.Linkages17)
	s.Linkages = append(s.Linkages, newValue)
	return newValue
}

func (s *SecuritiesFinancingInstructionV04) AddTradeDetails() *iso20022.SecuritiesTradeDetails3 {
...
func (s *SecuritiesFinancingInstructionV04) AddSecuritiesFinancingDetails() *iso20022.SecuritiesFinancingTransactionDetails11 {
...
func (s *SecuritiesFinancingInstructionV04) AddCashParties() *iso20022.CashParties17 {
...
func (s *SecuritiesFinancingInstructionV04) AddOtherAmounts() *iso20022.OtherAmounts14 {
...
func (s *SecuritiesFinancingInstructionV04) AddSupplementaryData() *iso20022.SupplementaryData1 {
	newValue := new(iso20022.SupplementaryData1)
	s.SupplementaryData = append(s.SupplementaryData, newValue)
	return newValue
}
func (d *Document03300104) String() (result string, ok bool) { return }
