...
func (s *SecuritiesSettlementAllegementRemovalAdviceV01) AddIdentification() *iso20022.DocumentIdentification11 {
	s.Identification = new(iso20022.DocumentIdentification11)
	return s.Identification
}

func (s *SecuritiesSettlementAllegementRemovalAdviceV01) AddDetails() *iso20022.TransactionDetails13 {
	s.Details = new(iso20022.TransactionDetails13)
	return s.Details
}

func (s *SecuritiesSettlementAllegementRemovalAdviceV01) AddMessageOriginator() *iso20022.PartyIdentification10Choice {
	s.MessageOriginator = new(iso20022.PartyIdentification10Choice)
	return s.MessageOriginator
}

func (s *SecuritiesSettlementAllegementRemovalAdviceV01) AddMessageRecipient() *iso20022.PartyIdentification10Choice {
	s.MessageRecipient = new(iso20022.PartyIdentification10Choice)
	return s.MessageRecipient
}

func (s *SecuritiesSettlementAllegementRemovalAdviceV01) AddExtension() *iso20022.Extension2 {
	newValue := new(iso20022.Extension2)
	s.Extension = append(s.Extension, newValue)
	return newValue
}
func (d *Document02900101) String() (result string, ok bool) { return }
