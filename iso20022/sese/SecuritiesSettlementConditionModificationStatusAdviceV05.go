...
func (d *Document03100105) AddMessage() *SecuritiesSettlementConditionModificationStatusAdviceV05 {
	d.Message = new(SecuritiesSettlementConditionModificationStatusAdviceV05)
	return d.Message
}
...
func (s *SecuritiesSettlementConditionModificationStatusAdviceV05) AddRequestReference() *iso20022.Identification1 {
	s.RequestReference = new(iso20022.Identification1)
	return s.RequestReference
}

func (s *SecuritiesSettlementConditionModificationStatusAdviceV05) AddAccountOwner() *iso20022.PartyIdentification36Choice {
	s.AccountOwner = new(iso20022.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesSettlementConditionModificationStatusAdviceV05) AddSafekeepingAccount() *iso20022.SecuritiesAccount13 {
	s.SafekeepingAccount = new(iso20022.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesSettlementConditionModificationStatusAdviceV05) AddRequestDetails() *iso20022.RequestDetails13 {
	s.RequestDetails = new(iso20022.RequestDetails13)
	return s.RequestDetails
}

func (s *SecuritiesSettlementConditionModificationStatusAdviceV05) AddProcessingStatus() *iso20022.ProcessingStatus18Choice {
	s.ProcessingStatus = new(iso20022.ProcessingStatus18Choice)
	return s.ProcessingStatus
}

func (s *SecuritiesSettlementConditionModificationStatusAdviceV05) AddSupplementaryData() *iso20022.SupplementaryData1 {
