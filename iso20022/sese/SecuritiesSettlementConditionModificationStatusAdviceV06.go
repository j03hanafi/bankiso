...
func (s *SecuritiesSettlementConditionModificationStatusAdviceV06) AddRequestReference() *iso20022.Identification1 {
	s.RequestReference = new(iso20022.Identification1)
	return s.RequestReference
}

func (s *SecuritiesSettlementConditionModificationStatusAdviceV06) AddAccountOwner() *iso20022.PartyIdentification36Choice {
	s.AccountOwner = new(iso20022.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesSettlementConditionModificationStatusAdviceV06) AddSafekeepingAccount() *iso20022.SecuritiesAccount13 {
	s.SafekeepingAccount = new(iso20022.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesSettlementConditionModificationStatusAdviceV06) AddRequestDetails() *iso20022.RequestDetails13 {
	s.RequestDetails = new(iso20022.RequestDetails13)
	return s.RequestDetails
}

func (s *SecuritiesSettlementConditionModificationStatusAdviceV06) AddProcessingStatus() *iso20022.ProcessingStatus44Choice {
	s.ProcessingStatus = new(iso20022.ProcessingStatus44Choice)
	return s.ProcessingStatus
}

func (s *SecuritiesSettlementConditionModificationStatusAdviceV06) AddSupplementaryData() *iso20022.SupplementaryData1 {
	newValue := new(iso20022.SupplementaryData1)
	s.SupplementaryData = append(s.SupplementaryData, newValue)
	return newValue
}
func (d *Document03100106) String() (result string, ok bool) { return }
