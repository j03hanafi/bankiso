...
func (d *Document02100103) AddMessage() *SecuritiesTransactionStatusQueryV03 {
	d.Message = new(SecuritiesTransactionStatusQueryV03)
	return d.Message
}
...
func (s *SecuritiesTransactionStatusQueryV03) AddStatusAdviceRequested() *iso20022.DocumentNumber9 {
	s.StatusAdviceRequested = new(iso20022.DocumentNumber9)
	return s.StatusAdviceRequested
}

func (s *SecuritiesTransactionStatusQueryV03) AddAccountOwner() *iso20022.PartyIdentification36Choice {
	s.AccountOwner = new(iso20022.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesTransactionStatusQueryV03) AddSafekeepingAccount() *iso20022.SecuritiesAccount13 {
	s.SafekeepingAccount = new(iso20022.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesTransactionStatusQueryV03) AddSupplementaryData() *iso20022.SupplementaryData1 {
	newValue := new(iso20022.SupplementaryData1)
	s.SupplementaryData = append(s.SupplementaryData, newValue)
	return newValue
}
func (d *Document02100103) String() (result string, ok bool) { return }
