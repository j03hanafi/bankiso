...
func (d *Document02300106) AddMessage() *SecuritiesSettlementTransactionInstructionV06 {
	d.Message = new(SecuritiesSettlementTransactionInstructionV06)
	return d.Message
}
...
func (s *SecuritiesSettlementTransactionInstructionV06) AddSettlementTypeAndAdditionalParameters() *iso20022.SettlementTypeAndAdditionalParameters11 {
	s.SettlementTypeAndAdditionalParameters = new(iso20022.SettlementTypeAndAdditionalParameters11)
	return s.SettlementTypeAndAdditionalParameters
}

func (s *SecuritiesSettlementTransactionInstructionV06) AddNumberCounts() *iso20022.NumberCount1Choice {
	s.NumberCounts = new(iso20022.NumberCount1Choice)
	return s.NumberCounts
}

func (s *SecuritiesSettlementTransactionInstructionV06) AddLinkages() *iso20022.Linkages37 {
	newValue := new(iso20022.Linkages37)
	s.Linkages = append(s.Linkages, newValue)
	return newValue
}

func (s *SecuritiesSettlementTransactionInstructionV06) AddTradeDetails() *iso20022.SecuritiesTradeDetails51 {
...
func (s *SecuritiesSettlementTransactionInstructionV06) AddFinancialInstrumentAttributes() *iso20022.FinancialInstrumentAttributes64 {
	s.FinancialInstrumentAttributes = new(iso20022.FinancialInstrumentAttributes64)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionInstructionV06) AddQuantityAndAccountDetails() *iso20022.QuantityAndAccount39 {
	s.QuantityAndAccountDetails = new(iso20022.QuantityAndAccount39)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesSettlementTransactionInstructionV06) AddSettlementParameters() *iso20022.SettlementDetails93 {
	s.SettlementParameters = new(iso20022.SettlementDetails93)
...
func (s *SecuritiesSettlementTransactionInstructionV06) AddReceivingSettlementParties() *iso20022.SettlementParties36 {
	s.ReceivingSettlementParties = new(iso20022.SettlementParties36)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionInstructionV06) AddCashParties() *iso20022.CashParties26 {
	s.CashParties = new(iso20022.CashParties26)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionInstructionV06) AddSettlementAmount() *iso20022.AmountAndDirection46 {
	s.SettlementAmount = new(iso20022.AmountAndDirection46)
	return s.SettlementAmount
}

func (s *SecuritiesSettlementTransactionInstructionV06) AddOtherAmounts() *iso20022.OtherAmounts28 {
	s.OtherAmounts = new(iso20022.OtherAmounts28)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionInstructionV06) AddOtherBusinessParties() *iso20022.OtherParties27 {
...
func (s *SecuritiesSettlementTransactionInstructionV06) AddSupplementaryData() *iso20022.SupplementaryData1 {
	newValue := new(iso20022.SupplementaryData1)
	s.SupplementaryData = append(s.SupplementaryData, newValue)
	return newValue
}
func (d *Document02300106) String() (result string, ok bool) { return }
