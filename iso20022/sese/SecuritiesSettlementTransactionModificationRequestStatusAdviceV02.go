...
func (d *Document03900102) AddMessage() *SecuritiesSettlementTransactionModificationRequestStatusAdviceV02 {
	d.Message = new(SecuritiesSettlementTransactionModificationRequestStatusAdviceV02)
	return d.Message
}
...
func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV02) AddModificationRequestReference() *iso20022.Identification1 {
	s.ModificationRequestReference = new(iso20022.Identification1)
	return s.ModificationRequestReference
}

func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV02) AddAccountOwner() *iso20022.PartyIdentification36Choice {
	s.AccountOwner = new(iso20022.PartyIdentification36Choice)
	return s.AccountOwner
}

func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV02) AddSafekeepingAccount() *iso20022.SecuritiesAccount13 {
	s.SafekeepingAccount = new(iso20022.SecuritiesAccount13)
	return s.SafekeepingAccount
}

func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV02) AddTransactionIdentification() *iso20022.TransactionIdentifications25 {
	s.TransactionIdentification = new(iso20022.TransactionIdentifications25)
	return s.TransactionIdentification
}

func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV02) AddModificationProcessingStatus() *iso20022.ModificationProcessingStatus2Choice {
	s.ModificationProcessingStatus = new(iso20022.ModificationProcessingStatus2Choice)
	return s.ModificationProcessingStatus
}

func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV02) AddTransactionDetails() *iso20022.TransactionDetails45 {
	s.TransactionDetails = new(iso20022.TransactionDetails45)
	return s.TransactionDetails
}

func (s *SecuritiesSettlementTransactionModificationRequestStatusAdviceV02) AddSupplementaryData() *iso20022.SupplementaryData1 {
	newValue := new(iso20022.SupplementaryData1)
	s.SupplementaryData = append(s.SupplementaryData, newValue)
	return newValue
}
func (d *Document03900102) String() (result string, ok bool) { return }
