...
func (s *SecuritiesSettlementTransactionReversalAdviceV03) AddTransactionIdentificationDetails() *iso20022.SettlementTypeAndIdentification15 {
...
func (s *SecuritiesSettlementTransactionReversalAdviceV03) AddConfirmationReference() *iso20022.Identification1 {
	s.ConfirmationReference = new(iso20022.Identification1)
	return s.ConfirmationReference
}

func (s *SecuritiesSettlementTransactionReversalAdviceV03) AddAdditionalParameters() *iso20022.AdditionalParameters14 {
	s.AdditionalParameters = new(iso20022.AdditionalParameters14)
	return s.AdditionalParameters
}

func (s *SecuritiesSettlementTransactionReversalAdviceV03) AddTradeDetails() *iso20022.SecuritiesTradeDetails2 {
...
func (s *SecuritiesSettlementTransactionReversalAdviceV03) AddFinancialInstrumentAttributes() *iso20022.FinancialInstrumentAttributes35 {
	s.FinancialInstrumentAttributes = new(iso20022.FinancialInstrumentAttributes35)
	return s.FinancialInstrumentAttributes
}

func (s *SecuritiesSettlementTransactionReversalAdviceV03) AddQuantityAndAccountDetails() *iso20022.QuantityAndAccount28 {
	s.QuantityAndAccountDetails = new(iso20022.QuantityAndAccount28)
	return s.QuantityAndAccountDetails
}

func (s *SecuritiesSettlementTransactionReversalAdviceV03) AddSettlementParameters() *iso20022.SettlementDetails45 {
	s.SettlementParameters = new(iso20022.SettlementDetails45)
	return s.SettlementParameters
}

func (s *SecuritiesSettlementTransactionReversalAdviceV03) AddStandingSettlementInstructionDetails() *iso20022.StandingSettlementInstruction5 {
...
func (s *SecuritiesSettlementTransactionReversalAdviceV03) AddDeliveringSettlementParties() *iso20022.SettlementParties14 {
	s.DeliveringSettlementParties = new(iso20022.SettlementParties14)
	return s.DeliveringSettlementParties
}

func (s *SecuritiesSettlementTransactionReversalAdviceV03) AddReceivingSettlementParties() *iso20022.SettlementParties14 {
	s.ReceivingSettlementParties = new(iso20022.SettlementParties14)
	return s.ReceivingSettlementParties
}

func (s *SecuritiesSettlementTransactionReversalAdviceV03) AddCashParties() *iso20022.CashParties9 {
	s.CashParties = new(iso20022.CashParties9)
	return s.CashParties
}

func (s *SecuritiesSettlementTransactionReversalAdviceV03) AddSettledAmount() *iso20022.AmountAndDirection2 {
	s.SettledAmount = new(iso20022.AmountAndDirection2)
	return s.SettledAmount
}

func (s *SecuritiesSettlementTransactionReversalAdviceV03) AddOtherAmounts() *iso20022.OtherAmounts18 {
	s.OtherAmounts = new(iso20022.OtherAmounts18)
	return s.OtherAmounts
}

func (s *SecuritiesSettlementTransactionReversalAdviceV03) AddOtherBusinessParties() *iso20022.OtherParties19 {
...
func (s *SecuritiesSettlementTransactionReversalAdviceV03) AddSupplementaryData() *iso20022.SupplementaryData1 {
