...
type ProxyLookUpResponseV01 struct {
	...
	SplmtryData []*iso20022.BI_SupplementaryData2   `xml:"SplmtryData" json:"SplmtryData"`
}
...
func (p *ProxyLookUpResponseV01) AddSplmtryData() []*iso20022.BI_SupplementaryData2 {
