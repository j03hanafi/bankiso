...
func (i *InitialBaselineSubmissionV04) AddInstruction() *iso20022.InstructionType1 {
	i.Instruction = new(iso20022.InstructionType1)
	return i.Instruction
}

func (i *InitialBaselineSubmissionV04) AddBaseline() *iso20022.Baseline4 {
	i.Baseline = new(iso20022.Baseline4)
	return i.Baseline
}
...
func (i *InitialBaselineSubmissionV04) AddBankContactPerson() *iso20022.BankContactPerson1Choice {
...
func (d *Document01900104) String() (result string, ok bool) { return }
