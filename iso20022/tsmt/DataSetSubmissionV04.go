...
func (d *DataSetSubmissionV04) AddBuyerBank() *iso20022.BICIdentification1 {
...
func (d *DataSetSubmissionV04) AddCommercialDataSet() *iso20022.CommercialDataSet4 {
	d.CommercialDataSet = new(iso20022.CommercialDataSet4)
	return d.CommercialDataSet
}

func (d *DataSetSubmissionV04) AddTransportDataSet() *iso20022.TransportDataSet4 {
	d.TransportDataSet = new(iso20022.TransportDataSet4)
...
func (d *Document01400104) String() (result string, ok bool) { return }
