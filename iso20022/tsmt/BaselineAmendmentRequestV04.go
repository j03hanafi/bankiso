...
func (d *Document00900104) AddMessage() *BaselineAmendmentRequestV04 {
	d.Message = new(BaselineAmendmentRequestV04)
	return d.Message
}
...
func (b *BaselineAmendmentRequestV04) AddBaseline() *iso20022.Baseline4 {
